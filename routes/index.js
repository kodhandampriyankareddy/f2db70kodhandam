...
router.get('/', function (req, res) {
 res.render('index', { title: 'jewellery App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'jewellery App Registration'});
});
...
router.get('/login', function(req, res) {
 res.render('login', { title: 'jewellery App Login', user : req.user });
});
